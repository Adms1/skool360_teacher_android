...
public class SentBirthDayWishTask extends AsyncTask<Void, Void, Boolean> {
    HashMap<String, String> param = new HashMap<String, String>();

    public SentBirthDayWishTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.BirthdayWish), param);
