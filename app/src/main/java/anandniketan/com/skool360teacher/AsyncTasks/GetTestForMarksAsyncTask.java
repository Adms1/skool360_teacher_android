...
public class GetTestForMarksAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {
    HashMap<String, String> param = new HashMap<String, String>();

    public GetTestForMarksAsyncTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected LeaveMainModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetTestForMarks), param);
            Gson gson = new Gson();
