...
public class GetStandardSectionForMarksAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {
    HashMap<String, String> param = new HashMap<String, String>();

    public GetStandardSectionForMarksAsyncTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected LeaveMainModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetStandardSectionForMarks), param);
            Gson gson = new Gson();
