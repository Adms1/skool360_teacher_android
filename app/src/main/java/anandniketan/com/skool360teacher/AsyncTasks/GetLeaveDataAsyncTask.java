...
public class GetLeaveDataAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {
    ...
    protected LeaveMainModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetStaffLeaveRequest), param);
            Gson gson = new Gson();
